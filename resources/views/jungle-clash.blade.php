...
<div id="mySidenav" class="fixed top-0 left-0 h-full w-0 z-10 bg-[#111] overflow-x-hidden transition-all duration-500 pt-[60px]">
    ...
    <form class="flex flex-col gap-2 px-8">
        ...
        <!-- <select id="group1Name" name="group1Name" value="Group1" class="mb-2 bg-gray-800 border border-gray-600 text-white rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
            <option value="0">Dora</option>
            <option value="1">Sinyo</option>
        </select> -->
        <input type="text" id="group1Name" name="group1Name" value="Group 1" class="mb-2 bg-gray-800 border border-gray-600 text-white rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
        ...
        <input type="text" id="group2Name" name="group2Name" value="Group 2" class="mb-2 bg-gray-800 border border-gray-600 text-white rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
